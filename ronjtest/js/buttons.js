...
$("#b66").click(function (e){
    colorize(6,11,"05cdff", "000");
    colorize(12,5,"2b77de", "000");
});
...
$("#b44").click(function (e){
    colorize(4,7,"05cdff", "000");
    colorize(8,11,"ffb005", "000");
    colorize(12,3,"c1ff05", "000");
});
...
$("#b33").click(function (e){
    colorize(3,5,"f646fd", "000");
    colorize(6,8,"05cdff", "000");
    colorize(9,11,"ffb005", "000");
    colorize(12,2,"c1ff05", "000");
});
